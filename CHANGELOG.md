...
- Template นำเข้านักเรียน 6 คอลัมน์: เลขประจำตัวนักเรียน, คำนำหน้า, ชื่อ, นามสกุล, ชั้น, ห้อง
- รองรับไฟล์นำเข้าแบบเก่า (ชื่อ-นามสกุล, ระดับชั้น, ห้องเรียน) และ alias `เลขประจำตัว`
...
- Excel หลังนำเข้าและตาราง preview ใช้คอลัมน์แบบเดียวกับ template โรงเรียน
- รวม `ชั้น` + `ห้อง` เป็น `ห้องเรียน` อัตโนมัติ (เช่น `ม.1` + `1` → `ม.1/1`)
- เก็บเลขประจำตัวนักเรียนตามในไฟล์ทุกตัวอักษร รวมเลข 0 นำหน้า
